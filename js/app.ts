...
const gameBox = document.getElementById('game-box') as HTMLElement;
const btnStartGame = document.querySelector('.btn-start-game') as HTMLElement;
const entry = document.querySelector('body') as HTMLElement;
const divHiddenWord = document.getElementById('hidden-word') as HTMLElement;
const btnNewGame = document.getElementById('btn-new-game') as HTMLElement;
const btnDesist = document.getElementById('btn-cancel') as HTMLElement;
const alertWin = document.querySelector('.alert-win') as HTMLElement;
const alertFail = document.querySelector('.alert-fail') as HTMLElement;
const alertSecretWord = document.getElementById('alert-secret-word') as HTMLElement;
const alertPoints = document.getElementById('alert-points') as HTMLElement;
const score = document.querySelector('.accumulated-points') as HTMLElement;
const keyQ = document.querySelector('.btn-Q') as HTMLInputElement;
const keyW = document.querySelector('.btn-W') as HTMLInputElement;
const keyE = document.querySelector('.btn-E') as HTMLInputElement;
const keyR = document.querySelector('.btn-R') as HTMLInputElement;
const keyT = document.querySelector('.btn-T') as HTMLInputElement;
const keyY = document.querySelector('.btn-Y') as HTMLInputElement;
const keyU = document.querySelector('.btn-U') as HTMLInputElement;
const keyI = document.querySelector('.btn-I') as HTMLInputElement;
const keyO = document.querySelector('.btn-O') as HTMLInputElement;
const keyP = document.querySelector('.btn-P') as HTMLInputElement;
const keyA = document.querySelector('.btn-A') as HTMLInputElement;
const keyS = document.querySelector('.btn-S') as HTMLInputElement;
const keyD = document.querySelector('.btn-D') as HTMLInputElement;
const keyF = document.querySelector('.btn-F') as HTMLInputElement;
const keyG = document.querySelector('.btn-G') as HTMLInputElement;
const keyH = document.querySelector('.btn-H') as HTMLInputElement;
const keyJ = document.querySelector('.btn-J') as HTMLInputElement;
const keyK = document.querySelector('.btn-K') as HTMLInputElement;
const keyL = document.querySelector('.btn-L') as HTMLInputElement;
const keyÑ = document.querySelector('.btn-Ñ') as HTMLInputElement;
const keyZ = document.querySelector('.btn-Z') as HTMLInputElement;
const keyX = document.querySelector('.btn-X') as HTMLInputElement;
const keyC = document.querySelector('.btn-C') as HTMLInputElement;
const keyV = document.querySelector('.btn-V') as HTMLInputElement;
const keyB = document.querySelector('.btn-B') as HTMLInputElement;
const keyN = document.querySelector('.btn-N') as HTMLInputElement;
const keyM = document.querySelector('.btn-M') as HTMLInputElement;
...
function removeWordDiv() {
    arrayWord = [];
    for (let i : number = 0; i < selectedWord.length; i++) {
        let removeDivHidden = document.getElementById(`${i}`) as HTMLElement;
...
function captureKey(event : KeyboardEvent) {
    const validation : string = 'QWERTYUIOPASDFGHJKLÑZXCVBNMqwertyuiopasdfghjklñzxcvbnm';
    ...
    if (arrayWord.includes(keyPressed)) {
        for (let i = 0; i < arrayWord.length; i++) {
            if (arrayWord[i] == keyPressed) {
                let found = i;
                win++;
                (document.getElementById(`${found}`) as HTMLElement).innerHTML = keyPressed;
                (document.getElementById(`${found}`) as HTMLElement).removeAttribute('class');
                (document.querySelector('.btn-' + keyPressed) as HTMLElement).style.backgroundColor = "green";
                (document.querySelector('.btn-' + keyPressed) as HTMLElement).style.color = "white";
                endGameMsg();
            }
        }
    } else {
        if (fail < 7) {
            ...
            (document.querySelector('.btn-' + keyPressed) as HTMLInputElement).style.backgroundColor = "red";
            (document.querySelector('.btn-' + keyPressed) as HTMLInputElement).style.color = "white";
            endGameMsg();
        }
    }
}
...
function hangedCharacter(condition) {
    const getImage = document.querySelector('#hanged-character img') as HTMLElement;
